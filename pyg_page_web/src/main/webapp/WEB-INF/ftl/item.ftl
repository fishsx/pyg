...
<html>
    ...
    <head>
        ...
        <script>
            //当前的规格
            var currSpec = ${item.spec};
            //当前SPU下的所有规格列表
            var specList =[
                <#list goodsVO.itemList as item>
            ...
            <div id="item">
                <div class="crumb-wrap">
                    <ul class="sui-breadcrumb">
                        <li>
                            <a href="#">${goodsVO.categoryNameList[0]!""}</a>
                        </li>
                        <li>
                            <a href="#">${goodsVO.categoryNameList[1]!""}</a>
                        </li>
                        <li>
                            <a href="#">${goodsVO.categoryNameList[2]!""}</a>
                        </li>
                        <li class="active">${goodsVO.goods.goodsName}</li>
                    </ul>
                </div>
                <!--product-info-->
                <div class="product-info">
                    <div class="fl preview-wrap">
					<#assign imageList = goodsVO.goodsDesc.itemImages?eval/>
                        <!--放大镜效果-->
                        <div class="zoom">
                            <!--默认第一个预览-->
                    ...
                    <div class="fr itemInfo-wrap">
                        ...
                        <div class="news"><span>${item.sellPoint!goodsVO.goods.caption}</span></div>
                        <div class="summary">
                        ...
                        <div class="clearfix choose">
                            ...
                            <#assign specList = goodsVO.goodsDesc.specificationItems?eval/>
                                <#assign currSpec = item.spec?eval/>
							<#list specList as spec>
                                <dl>
                                    ...
                                    <#--</a></dd>-->
                                    <#list spec.attributeValue as specAttr>
                                        <dd><a href="javascript:;" ng-click="jumpTargetItem('${spec.attributeName}','${specAttr}')"
                                               <#if currSpec[spec.attributeName] == specAttr>class="selected"</#if>
                                        >${specAttr}<span title="点击取消选择">&nbsp;</span></a></dd>
                                    </#list>
                                </dl>
                            </#list>
                            ...
                            <div class="summary-wrap">
                                <div class="fl title">
                                    <div class="control-group">
                                        <div class="controls">
                                            <input autocomplete="off" type="text" value="{{buyNum}}" minnum="1" class="itxt"/>
                                            <a href="javascript:void(0)" ng-click="addNum(buyNum+1)" class="increment plus">+</a>
                                            <a href="javascript:void(0)" ng-click="addNum(buyNum-1)" class="increment mins">-</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="fl">

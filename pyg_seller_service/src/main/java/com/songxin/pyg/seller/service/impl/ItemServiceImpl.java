...
import com.songxin.pyg.seller.service.ItemService;
...
import com.songxin.pyg.pojo.TbItemExample.Criteria;
...
public class ItemServiceImpl implements ItemService {
	 ...
	 */
	@Override
	public TbItem findOneById(Long id){
	 ...
	 */
	@Override
	public PageResultVO findByCondition(TbItem item, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
